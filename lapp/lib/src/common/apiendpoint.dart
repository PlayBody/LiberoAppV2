...
//String apiBase = 'http://10.10.14.209/cloud_devotion';
//String apiNewBase = 'http://10.10.14.209/cloud_devotion/apis';
...
String apiLoadOrgans = '$apiNewBase/organs/getOrganList';

String apiLoadMenuListUrl = '$apiNewBase/menu/getMenuList';

String apiLoadReserveTimeStatus = '$apiNewBase/order/getOrderEnableHours';
String apiLoadShiftFrames = '$apiNewBase/shiftFrame/loadShiftFrameOfReserve';

String apiSaveReserveDataUrl = '${apiNewBase}/order/reserveOrder';
